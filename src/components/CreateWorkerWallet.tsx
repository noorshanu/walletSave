  ...
  return (
    <div className=" mt-8">
      ...
      <div className=" flex justify-center gap-8 mt-8 ">
        <div className="bg-white shadow-xl rounded-2xl dark:bg-[#1c1d32] px-4 py-8 border border-[#19f48a9f]  sm:w-[500px] ">
          <div className="mt-6">
            ...
            />
            <button
              className="mt-4 bg-primary-gradient text-white px-8 py-2 rounded-full mx-auto flex justify-center font-semibold "

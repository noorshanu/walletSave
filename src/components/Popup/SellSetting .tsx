...
const SellSetting = () => {
  return (
    <div className=' container w-full p-4 bg-white shadow-md dark:bg-[#191919]  rounded-lg'>
        <div className=' my-2'>
            <label htmlFor="" className='mb-2 block text-black-2 dark:text-white'>Set Min Sell Amount</label>
        ...
        <div className=' my-2'>
            <label htmlFor="" className='mb-2 block text-black-2 dark:text-white'>Set Max Sell Amount</label>
            <input type="number" placeholder='0.00' className='w-full rounded-md border border-[#434C59] bg-white p-2 shadow-lg dark:bg-[#191919]' />
        </div>
        <div className=' my-2'>
        ...
        <div className=' my-2'>
            <label htmlFor="" className='mb-2 block text-black-2 dark:text-white'>Set Quick Sell</label>
            <input type="number" placeholder='0.00' className='w-full rounded-md border border-[#434C59] bg-white p-2 shadow-lg dark:bg-[#191919]' />
        </div>
        <div className=' my-2'>
